...
import EventDetail from '../../assests/EventBanner.png';
  ...
  return (
    <ScrollView>
      <View style={{backgroundColor: '#fff', paddingTop: 25}}>
        ...
        <Text style={styles.profileCaption}>"Run the world" out now!</Text> */}
        <View style={styles.postImageMain}>
          <Image source={EventDetail} style={styles.postImage} />
        ...
        <View>
          <View>
            <Text style={styles.profileTitle}>
              Songs Night open mic at Boston Hotel
            </Text>
            {/* <Text style={styles.profileState}>L.A. United States</Text> */}
          </View>
        </View>
        <Text style={styles.profileTime}>Organised by Grame Smith</Text>
        <Text style={styles.profileTime}>Lara Djonggrang Central Jakarta City, Jakarta, Indonesia</Text>
